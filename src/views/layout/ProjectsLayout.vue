...
motion(id="projects" is="section" preset="slideVisibleOnceBottom" class="sm:px-8 m-8" :delay="200" :duration="1000")
  ...
  .max-w-2xl.px-4.py-16(class="sm:px-6 sm:py-12 lg:max-w-7xl lg:px-8 flex mx-auto xl:flex-nowrap flex-wrap justify-center")
    .m-4(v-for="(project, index) in projects" :key="index" class="group/item group  relative max-w-md" )
